...
cat("=============================================================================\n")
cat("META-ANALYSIS: SSP-ONLY S/IS (Pearson's r)\n")
cat("=============================================================================\n\n")
...
data <- read.csv(file.path(data_dir, "data_ssp_only_es.csv"), stringsAsFactors = FALSE)
...
data <- data %>%
  mutate(
    ...
    # Create moderator variables (no measure_type for SSP-only)
...
# Create forest plot
forest_file <- file.path(figures_dir, "forest_ssp_only.tiff")
...
funnel_file <- file.path(figures_dir, "funnel_ssp_only.tiff")
...
plot(
  ...
  xlab = "Pearson'''s r",
  ylab = "Standard Error",
  main = "Funnel Plot: SSP-only Continuity"
)
...
cat("=============================================================================\n")
cat("META-ANALYSIS: SSP-ONLY SECURE/INSECURE ATTACHMENT CONTINUITY\n")
cat("Infant/Child to Adult Attachment (SSP → AAI)\n")
cat("=============================================================================\n\n")
