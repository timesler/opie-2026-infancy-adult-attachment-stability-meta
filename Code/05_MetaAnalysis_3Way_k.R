# =============================================================================
# 05_MetaAnalysis_3Way_k.R
# =============================================================================
# Purpose: Meta-analysis of 3-way (A/B/C) attachment continuity
#          from infancy to adulthood using Cohen's kappa
# Input:   data_3way_es.csv (with effect sizes)
...
cat("=============================================================================\n")
cat("META-ANALYSIS: 3-WAY A/B/C (Cohen's kappa)\n")
cat("=============================================================================\n\n")
...
data <- read.csv(file.path(data_dir, "data_3way_es.csv"), stringsAsFactors = FALSE)
...
# Create forest plot
forest_file <- file.path(figures_dir, "forest_3way.tiff")

create_forest_plot(
  data_forest = data_forest,
  output_file = forest_file,
  main_title = "3-Way A/B/C Attachment Continuity (Infancy to Adulthood)",
  xlab = "Cohen's kappa",
  xlim = c(-5, 2.5),
  alim = c(-0.5, 0.5)
)
...
funnel_file <- file.path(figures_dir, "funnel_3way.tiff")
...
plot(
  ...
  xlab = "kappa",
  ylab = "Standard Error",
  main = "Funnel Plot: 3-way A/B/C Continuity"
)
...
cat("=============================================================================\n")
cat("META-ANALYSIS: 3-WAY A/B/C ATTACHMENT CONTINUITY\n")
