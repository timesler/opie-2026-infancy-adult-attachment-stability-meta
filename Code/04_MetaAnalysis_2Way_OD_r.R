...
cat("=============================================================================\n")
cat("META-ANALYSIS: 2-WAY ORGANIZED/DISORGANIZED (Pearson's r)\n")
cat("=============================================================================\n\n")
...
data <- read.csv(file.path(data_dir, "data_2way_od_es.csv"), stringsAsFactors = FALSE)
...
# Create forest plot
forest_file <- file.path(figures_dir, "forest_2way_od.tiff")
...
forest.col(
  ...
  digits = 2,
  xlab = "Pearson's r",
  main = "Organized/Disorganized Attachment Continuity (Infancy to Adulthood)",
...
funnel_file <- file.path(figures_dir, "funnel_2way_od.tiff")
...
plot(
  ...
  xlab = "Pearson's r",
  ylab = "Standard Error",
  main = "Funnel Plot: 2-way O/D Continuity"
)
...
cat("=============================================================================\n")
cat("META-ANALYSIS: 2-WAY ORGANIZED/DISORGANIZED ATTACHMENT CONTINUITY\n")
